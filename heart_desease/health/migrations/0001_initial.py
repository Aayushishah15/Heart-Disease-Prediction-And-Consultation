# Generated by Django 3.1.3 on 2023-04-02 09:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prediction_accuracys', models.CharField(blank=True, max_length=100, null=True)),
                ('prediction_accuracyss', models.CharField(blank=True, max_length=100, null=True)),
                ('result', models.CharField(blank=True, max_length=100, null=True)),
                ('results', models.CharField(blank=True, max_length=100, null=True)),
                ('resultss', models.CharField(blank=True, max_length=100, null=True)),
