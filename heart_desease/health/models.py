...
class Search_Data(models.Model):
    ...
    prediction_accuracys = models.CharField(max_length=100,null=True,blank=True)
    prediction_accuracyss = models.CharField(max_length=100,null=True,blank=True)
    result = models.CharField(max_length=100,null=True,blank=True)
    results = models.CharField(max_length=100,null=True,blank=True)
    resultss = models.CharField(max_length=100,null=True,blank=True)
